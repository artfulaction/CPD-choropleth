...
I obtained the Chicago Police Department's gang database from Propublica. It's a dataset that CPD created to list individuals that classify as gang members.

Here, I'm making this gang data into a choropleth map of Chicago, which will display shading based on the number of individuals indicated as being gang members in each of Chicago's community areas.
